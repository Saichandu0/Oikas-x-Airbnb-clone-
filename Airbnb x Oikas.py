# Airbnb x Oikas - Single File App
...
/* Centered overlay for welcome title */
.center-hero {
    position: absolute;
    top: 50%;
    left: 50%;
...
def populate_sample_data():
    ...
    # Global properties with reliable image URLs
    global_properties = [
        (1, "Manhattan Skyline Penthouse", "Breathtaking penthouse with panoramic city views.", "Penthouse", "New York", "USA", "123 5th Avenue, New York", 450.0, 6, 3, 2, '["WiFi", "Kitchen", "AC", "TV", "Balcony", "Gym"]', "https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=400&h=300&fit=crop"),
        (2, "Covent Garden Luxury Flat", "Elegant Victorian flat in London's theater district.", "Apartment", "London", "UK", "78 Covent Garden, London", 280.0, 4, 2, 2, '["WiFi", "Kitchen", "Heating", "TV"]', "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=400&h=300&fit=crop"),
        (3, "Montmartre Artist Retreat", "Charming Parisian apartment in historic Montmartre.", "Apartment", "Paris", "France", "34 Rue des Abbesses, Paris", 195.0, 2, 1, 1, '["WiFi", "Kitchen", "Heating"]', "https://images.unsplash.com/photo-1502602898536-47ad22581b52?w=400&h=300&fit=crop"),
        (1, "Shibuya Modern Capsule", "Ultra-modern apartment in bustling Shibuya.", "Studio", "Tokyo", "Japan", "2-1 Shibuya, Tokyo", 85.0, 2, 1, 1, '["WiFi", "AC", "TV"]', "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=400&h=300&fit=crop"),
        (2, "Bondi Beach Surf House", "Beachfront house steps from famous Bondi Beach.", "House", "Sydney", "Australia", "88 Campbell Parade, Bondi", 320.0, 8, 4, 3, '["WiFi", "Kitchen", "AC", "Balcony"]', "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&h=300&fit=crop"),
        (3, "Burj Khalifa Sky Suite", "Luxurious suite with views of Burj Khalifa.", "Suite", "Dubai", "UAE", "Downtown Dubai Marina", 520.0, 6, 3, 3, '["WiFi", "Kitchen", "AC", "Pool", "Gym"]', "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=400&h=300&fit=crop"),
        (1, "Gaudi Modernist Flat", "Artistic apartment inspired by Antoni Gaudí.", "Apartment", "Barcelona", "Spain", "Carrer del Bisbe, Barcelona", 165.0, 3, 1, 1, '["WiFi", "Kitchen", "AC"]', "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=400&h=300&fit=crop"),
        (2, "Canal House Floating Hotel", "Unique houseboat on Amsterdam's canals.", "Houseboat", "Amsterdam", "Netherlands", "Prinsengracht 263, Amsterdam", 145.0, 2, 1, 1, '["WiFi", "Kitchen", "Heating"]', "https://images.unsplash.com/photo-1534351590666-13e3e96b5017?w=400&h=300&fit=crop"),
    ]
...
# Authentication page
def show_auth_page():
    # Beach background with centered welcome overlay
    st.markdown("""
    <div class="beach-bg">
...
def show_main_app():
    ...
    # Simple page indicator (removed styled name tag)
    page_names = {
    ...
    # Simple subheading instead of styled name tag
            ...
            if i + j < len(properties):
                ...
                with col:
                    with st.container():
                        ...
                        if prop[13] and prop[13].strip():
                            try:
                                st.image(prop[13], use_column_width=True)
                            except:
                                st.image("https://via.placeholder.com/400x300/1a1a1a/87CEEB?text=Property+Image", use_column_width=True)
                        else:
                            st.image("https://via.placeholder.com/400x300/1a1a1a/87CEEB?text=Property+Image", use_column_width=True)
